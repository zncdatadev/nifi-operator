...
[![Build](https://github.com/zncdatadev/nifi-operator/actions/workflows/publish.yml/badge.svg)](https://github.com/zncdatadev/nifi-operator/actions/workflows/publish.yml)
[![LICENSE](https://img.shields.io/badge/license-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![Go Report Card](https://goreportcard.com/badge/github.com/zncdatadev/nifi-operator)](https://goreportcard.com/report/github.com/zncdatadev/nifi-operator)
[![Artifact HUB](https://img.shields.io/endpoint?url=https://artifacthub.io/badge/repository/nifi-operator)](https://artifacthub.io/packages/helm/kubedoop/nifi-operator)

This is a Kubernetes operator to manage Apache Nifi ensembles.
...
```bash
helm install nifi-operator kubedoop/nifi-operator
```
