...
## Purpose
Manages Apache NiFi deployments on Kubernetes. Handles creation, configuration, and lifecycle management of NiFi clusters for data routing and transformation.
...
| Directory | Purpose |
|-----------|---------|
| `api/` | Kubernetes CRD definitions for NiFi |
